...
public sealed class NaniTypeLayoutTable
{
	...
	private void AddCommandLayouts()
	{
		...
		AddCommand("PrintText", new()
		{
			...
			new("PrinterId", N? NaniFieldType.CommandParameter, "printer", "StringParameter"),
...
;			new("Params", NaniFieldType.CommandParameter, "", "StringListParameter"),
		...
		AddCommand("ModifyCamera", new()
		{
			...
			new("Rotation", NaniFieldType.CommandParameter, "", "DecimalListParameter"),
			new("Zoom", Nani! NaniFieldType.CommandParameter, "", "DecimalParameter"),
		...
		{
			new("InputEnabled", Nani) NaniFieldType.CommandParameter, "", "BooleanParameter"),
	...
	private void AddCommandWithBase(string className, List<NaniCTypeField> baseFields, List<NaniTypeField> derivedFields)
	{
		List<NaniTypeField> fields = CommandBaseFields();
